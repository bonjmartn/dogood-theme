...
class homefeature_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Homepage Feature', 'do-good' ), // Name
      array( 'description' => __( 'Featured content with a button for the homepage', 'do-good' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Feature Title', 'do-good' );
