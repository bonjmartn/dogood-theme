...
class ctabutton_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Call to Action Button', 'do-good-free' ), // Name
      array( 'description' => __( 'Use me for the Homepage Button', 'do-good-free' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( '', 'do-good-free' );
