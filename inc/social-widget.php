...
class social_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Social Icons', 'do-good' ), // Name
      array( 'description' => __( 'Drag me to the Footer 4 widget area', 'do-good' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Follow Us', 'do-good' );
    $facebook = ! empty( $instance['facebook'] ) ? $instance['facebook'] : __( '', 'do-good' );
    $twitter = ! empty( $instance['twitter'] ) ? $instance['twitter'] : __( '', 'do-good' );
    $pinterest = ! empty( $instance['pinterest'] ) ? $instance['pinterest'] : __( '', 'do-good' );
    $instagram = ! empty( $instance['instagram'] ) ? $instance['instagram'] : __( '', 'do-good' );
    $googleplus = ! empty( $instance['googleplus'] ) ? $instance['googleplus'] : __( '', 'do-good' );
    $yelp = ! empty( $instance['yelp'] ) ? $instance['yelp'] : __( '', 'do-good' );
    $youtube = ! empty( $instance['youtube'] ) ? $instance['youtube'] : __( '', 'do-good' );
    $linkedin = ! empty( $instance['linkedin'] ) ? $instance['linkedin'] : __( '', 'do-good' );
    ?>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('facebook_field'); ?>"><?php _e('Enter the URL for your Facebook page', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('twitter_field'); ?>"><?php _e('Enter the URL for your Twitter profile', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('pinterest_field'); ?>"><?php _e('Enter the URL for your Pinterest page', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('instagram_field'); ?>"><?php _e('Enter the URL for your Instagram profile', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('googleplus_field'); ?>"><?php _e('Enter the URL for your Google Plus profile', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('yelp_field'); ?>"><?php _e('Enter the URL for your Yelp page', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('youtube_field'); ?>"><?php _e('Enter the URL for your YouTube page', 'do-good'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('linkedin_field'); ?>"><?php _e('Enter the URL for your LinkedIn profile', 'do-good'); ?></label>
