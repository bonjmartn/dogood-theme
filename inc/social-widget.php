...
class social_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Social Icons', 'do-good-free' ), // Name
      array( 'description' => __( 'Drag me to the Footer 4 widget area', 'do-good-free' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Follow Us', 'do-good-free' );
    $facebook = ! empty( $instance['facebook'] ) ? $instance['facebook'] : __( 'https://www.facebook.com', 'do-good-free' );
    $twitter = ! empty( $instance['twitter'] ) ? $instance['twitter'] : __( 'https://www.twitter.com', 'do-good-free' );
    $pinterest = ! empty( $instance['pinterest'] ) ? $instance['pinterest'] : __( 'https://www.pinterest.com', 'do-good-free' );
    $instagram = ! empty( $instance['instagram'] ) ? $instance['instagram'] : __( 'https://www.instagram.com', 'do-good-free' );
    $googleplus = ! empty( $instance['googleplus'] ) ? $instance['googleplus'] : __( 'https://plus.google.com', 'do-good-free' );
    $yelp = ! empty( $instance['yelp'] ) ? $instance['yelp'] : __( 'https://www.yelp.com', 'do-good-free' );
    $youtube = ! empty( $instance['youtube'] ) ? $instance['youtube'] : __( 'https://www.youtube.com', 'do-good-free' );
    $linkedin = ! empty( $instance['linkedin'] ) ? $instance['linkedin'] : __( 'https://www.linkedin.com', 'do-good-free' );
    ?>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('facebook_field'); ?>"><?php _e('Enter the URL for your Facebook page', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('twitter_field'); ?>"><?php _e('Enter the URL for your Twitter profile', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('pinterest_field'); ?>"><?php _e('Enter the URL for your Pinterest page', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('instagram_field'); ?>"><?php _e('Enter the URL for your Instagram profile', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('googleplus_field'); ?>"><?php _e('Enter the URL for your Google Plus profile', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('yelp_field'); ?>"><?php _e('Enter the URL for your Yelp page', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('youtube_field'); ?>"><?php _e('Enter the URL for your YouTube page', 'do-good-free'); ?></label>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('linkedin_field'); ?>"><?php _e('Enter the URL for your LinkedIn profile', 'do-good-free'); ?></label>
